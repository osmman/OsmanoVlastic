...
{
    public static void registerInInterceptor(Object service, Map<String, Object> context)
    {
    ...
    public static void registerOutInterceptor(Object service, Map<String, Object> context)
    {
